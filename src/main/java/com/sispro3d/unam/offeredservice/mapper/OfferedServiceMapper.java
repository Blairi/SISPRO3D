...
public class OfferedServiceMapper {
    ...
    public OfferedServiceResponse toResponse(OfferedService service) {
        ...
        return OfferedServiceResponse.builder()
                ...
                .expertName(service.getExpert() != null ? service.getExpert().getName() + " " + service.getExpert().getLastName() : null)
                .expertEmail(service.getExpert() != null ? service.getExpert().getEmail() : null)
